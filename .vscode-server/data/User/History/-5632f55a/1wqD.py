...
def analyze_with_suricata(pcap_file, rule_file):
    ...
    command = f"suricata -r {pcap_file} -c /etc/suricata/suricata.yaml -l ./output -S {rule_file}"
...
pcap_file = "4.pcap"
rule_file = "/etc/suricata/rules/suricata.rules"  # Path to Suricata rule file
...
print("Features detected by Python code:")
print(data)
